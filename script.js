...
//    numOfImages = 0;
//    finishedGame = false;
//    easyButton.style.backgroundColor = '#7a5b93';
//    mediumButton.style.backgroundColor = '#7a5b93';
//    hardButton.style.backgroundColor = '#7a5b93';
...
images.map((image,idx) => {
   const imageURL = image.src.tiny;
   const gridItem = document.createElement("div");
//    gridItem.classList.add(`grid-${idx}`);
   gridItem.tabIndex = 0;
   const imageElement = document.createElement("img");
   imageElement.id = `img-${image.id}`;
   imageElement.src = imageURL;
...
//     if(audioButton.innerText === 'Audio On'){
//         audioButton.innerText = 'Audio Off';
//         audioContext.resume();
//     }else{
//         audioButton.innerText = 'Audio On';
//         stopAudio(countdownAudio);
//         stopAudio(ranOutAudio);
//         stopAudio(turnCardAudio);
//         stopAudio(winningAudio);
